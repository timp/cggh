		...
		String decoratedXHTMLTable = null;
			...
			try {
				if (this.getCachedRowSet().next()) {
					...
					decoratedXHTMLTable = decoratedXHTMLTable.concat("<table class=\"data-table\">");
					 ...
					 decoratedXHTMLTable = decoratedXHTMLTable.concat("<th class=\"idHeadingContainer\">ID<!--  <a href=\"javascript:TODOsort();\">sort up/down</a> --></th>");
					...
					while (this.getCachedRowSet().next()) {
						...
						decoratedXHTMLTable = decoratedXHTMLTable.concat("<tr class=\"" + rowStripeClassName + rowFirstClassName + rowLastClassName + "\">");
						 ...
						 decoratedXHTMLTable = decoratedXHTMLTable.concat("<td class=\"idContainer\">" + this.getCachedRowSet().getString("id") + "</td>");
