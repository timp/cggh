				...
				<tr>
					...
					<td>
						<ol class="sources-list">
							<li><a href="<%=resolutionsByCellBasePathURL %>files/<%=mergeModel.getFile1Model().getId()%>"><%=mergeModel.getFile1Model().getFilename()%></a></li>
							<li><a href="<%=resolutionsByCellBasePathURL %>files/<%=mergeModel.getFile2Model().getId()%>"><%=mergeModel.getFile2Model().getFilename()%></a></li>
						</ol>
					</td>
				</tr>
