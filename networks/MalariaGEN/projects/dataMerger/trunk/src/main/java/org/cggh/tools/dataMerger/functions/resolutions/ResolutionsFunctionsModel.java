package org.cggh.tools.dataMerger.functions.resolutions;
...
public class ResolutionsFunctionsModel implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7663105154570885669L;
	private final Logger logger = Logger.getLogger("org.cggh.tools.dataMerger.functions.resolutions");
	private String urlBasePath;
	private MergeModel mergeModel;
	private HttpServletRequest httpServletRequest;
	
	
	public ResolutionsFunctionsModel () {
