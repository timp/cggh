...
<html>
	<head>
		...
		<title>dataMerger - Guides - Installation - Errors - Database version</title>
		...
		<div class="page">
			...
			<div class="guides-container">
				...
				<div class="guide">
					...
					<p>The database cannot be installed.</p>
					
					<p>Possible causes and solutions:
						<ul>
							<li>The version of the currently installed database is inappropriate.</li>
						</ul>
					
					</p>			
					
					<p>To reinstall database version 1.0, first uninstall v.1.0.
					</p>
